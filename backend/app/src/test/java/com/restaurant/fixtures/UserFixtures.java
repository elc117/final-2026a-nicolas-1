...
public class UserFixtures {
    ...
    public static User createTestUser() {
        return new User(Long.valueOf(0), "marcelo", "marcelo123", AccessProfile.GENERAL);
    }
    ...
    public static List<User> createTestUsers() {
        ...
        users.add(new User(Long.valueOf(0), "davi", "davi321", AccessProfile.GENERAL));
        users.add(new User(Long.valueOf(0), "bernardo", "bernardo231", AccessProfile.GENERAL));
